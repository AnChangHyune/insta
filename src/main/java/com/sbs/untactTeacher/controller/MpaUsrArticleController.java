...
public class MpaUsrArticleController {
	...
	public String doWrite(HttpServletRequest req, int boardId, String title, String body) {
		...
		Member member = memberService.getMemberById(boardId);
		int memberId = member.getId(); //임시
		...
		String replaceUrl = "detail?id="+WriteRd.getBody().get("id");
		
		return Util.msgAndReplace(req, WriteRd.getMsg(), replaceUrl);
	}
